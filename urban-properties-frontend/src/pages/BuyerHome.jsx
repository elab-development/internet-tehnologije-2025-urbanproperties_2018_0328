...
/*
  ...
  - UI natpisi su na engleskom.
  - Moderan "card" dizajn u skladu sa logom (dark + accent red).
*/
      ...
      <div style={styles.container}>
        <header style={styles.headerCard}>
          ...
          <div style={styles.badgeRow}>
            ...
            <span style={styles.badgeSoft}>Urban Properties</span>
          </div>

          <h1 style={styles.title}>Buyer Home</h1>
          <p style={styles.subtitle}>
            Explore listings, view details, and schedule a viewing appointment.
          </p>
