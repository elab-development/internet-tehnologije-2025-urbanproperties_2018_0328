// src/pages/sales_agent/SalesAgentHome.jsx
import Slider from "../components/Slider";

/*
  Sales Agent home page.
  - Fokus: upravljanje oglasima i praćenje aktivnosti.
      ...
      <div style={styles.container}>
        <header style={styles.headerCard}>
          ...
          <div style={styles.badgeRow}>
            <span style={styles.badge}>SALES AGENT</span>
            <span style={styles.badgeSoft}>Listings & Appointments</span>
          </div>

          <h1 style={styles.title}>Sales Agent Home</h1>
          <p style={styles.subtitle}>
            Manage your properties, monitor viewing appointments, and review
            offers.
          </p>
